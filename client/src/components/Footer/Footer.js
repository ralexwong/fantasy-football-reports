        ...
        <div className='footer__info'>
          <div className='footer__navigation'>
            <ul className='footer__list'>
              <li className='footer__item'><a href='https://github.com/ralexwong' className='footer__link'>github</a></li>
              <li className='footer__item'><a href='https://www.linkedin.com/in/iamwong/' className='footer__link'>linkedin</a></li>
            </ul>
          </div>
